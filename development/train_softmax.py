...
num_subjects =  len(np.unique(data['y_train'][:])) #len(np.unique(fileh.root.label_train[:]))
...
def main(_):
    ...
    with graph.as_default(), tf.device('/cpu:0'):
        ...
        ########## required from data ###########
        #########################################
        num_samples_per_epoch = data['y_train'].shape[0] #fileh.root.label_train.shape[0]
        num_batches_per_epoch = int(num_samples_per_epoch / FLAGS.batch_size)

        num_samples_per_epoch_test = data['y_train'].shape[0] #fileh.root.label_test.shape[0]
    ...
    with tf.Session(graph=graph, config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        ...
        for epoch in range(FLAGS.num_epochs):
            ...
            for batch_num in range(num_batches_per_epoch):
                ...
                speech_train, label_train = data['x_train'], data['y_train'] #fileh.root.utterance_train[start_idx:end_idx, :, :,:], fileh.root.label_train[start_idx:end_idx]
            ...
            for i in range(num_batches_per_epoch_test):
                ...
                speech_test, label_test = data['x_test'],data['y_test'] #fileh.root.utterance_test[start_idx:end_idx, :, :,:], fileh.root.label_test[start_idx:end_idx]
